          ...
          >
            <div className={`p-8 rounded-lg shadow-lg ${
              ...
              <div className="flex items-center mb-4">
                ...
                <span className="text-gray-600 dark:text-gray-300">Argentina, Chubut</span>
              </div>
              <div className="flex items-center mb-4">
                <Code className={`w-6 h-6 mr-2 ${
                  theme === 'dark' ? 'text-red-500' : 'text-blue-600'
                }`} />
                <span className="text-gray-600 dark:text-gray-300">4+ años de experiencia</span>
              </div>
              <div className="flex items-center">
                <Briefcase className={`w-6 h-6 mr-2 ${
                  theme === 'dark' ? 'text-red-500' : 'text-blue-600'
                }`} />
                <span className="text-gray-600 dark:text-gray-300">Analista de Sistemas</span>
              </div>
            </div>
          </motion.div>
